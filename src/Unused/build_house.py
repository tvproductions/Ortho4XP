...
def rotation_matrix(axis, angle):
    ...
    if axis == "z":
        return numpy.array(
            [[cos(a), -sin(a), 0], [sin(a), cos(a), 0], [0, 0, 1]], dtype=float
        )
    elif axis == "x":
        return numpy.array(
            [[1, 0, 0], [0, cos(a), -sin(a)], [0, sin(a), cos(a)]], dtype=float
        )
    else:
        return numpy.array(
            [[cos(a), 0, sin(a)], [0, 1, 0], [-sin(a), 0, cos(a)]], dtype=float
        )
...
def face_a_plat(vertex_list):
    ...
    for x, y in vertex_list:
        face.append(numpy.array([x, y, 0, 0, 0, 1, 0, 0], dtype=float))
    return face
